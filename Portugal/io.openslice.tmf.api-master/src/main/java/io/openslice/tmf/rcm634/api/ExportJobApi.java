...
public interface ExportJobApi {
    ...
    default ResponseEntity<ExportJob> createExportJob(@Parameter(description = "The ExportJob to be created" ,required=true )  @Valid @RequestBody ExportJobCreate body
) {
    ...
    default ResponseEntity<List<ExportJob>> listExportJob(@Parameter(description = "Comma-separated properties to be provided in response") @Valid @RequestParam(value = "fields", required = false) String fields
...
,@Parameter(description = "Requested number of resources to be provided in response") @Valid @RequestParam(value = "limit", required = false) Integer limit
    ...
    @RequestMapping(value = "/exportJob/{id}",
        produces = { "application/json;charset=utf-8" }, 
        method = RequestMethod.GET)
    default ResponseEntity<ExportJob> retrieveExportJob(@Parameter(description = "Identifier of the ExportJob",required=true) @PathVariable("id") String id
