...
public class MediumCharacteristic extends BaseRootEntity {
	...
	public MediumCharacteristic(@NotNull @Valid MediumCharacteristic c) {
		this.city = c.city;
		this.contactType = c.contactType;
		this.country = c.country;
		this.emailAddress = c.emailAddress;
		this.faxNumber = c.faxNumber;
		this.phoneNumber = c.phoneNumber;
		this.postCode = c.postCode;
		this.socialNetworkId = c.socialNetworkId;
		this.stateOrProvince = c.stateOrProvince;
		this.street1 = c.street1;
		this.street2 = c.street2;
	}
