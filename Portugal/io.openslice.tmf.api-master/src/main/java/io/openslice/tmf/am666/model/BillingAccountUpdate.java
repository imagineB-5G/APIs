 ...
 */
@Schema(description = "A party account used for billing purposes. It includes a description of the bill structure (frequency, presentation media, format and so on). It is a specialization of entity PartyAccount. Skipped properties: id,href,accountBalance")
@Validated
...
public class BillingAccountUpdate   {
  ...
  **/
  ...
  public BillingAccountUpdate ratingType(String ratingType) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.accountType, billingAccountUpdate.accountType) &&
        ...
        Objects.equals(this.ratingType, billingAccountUpdate.ratingType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountType, description, lastModified, name, paymentStatus, ratingType, state, accountRelationship, billStructure, contact, creditLimit, defaultPaymentMethod, financialAccount, paymentPlan, relatedParty, taxExemption, baseType, schemaLocation, type);
  }
