 ...
 */
@Schema(description = "A detailed description of the way in which a bill is presented. Skipped properties: id,href")
@Validated
...
public class BillFormatCreate   {
   ...
   * @return description
  **/
  @Schema(description = "An explanatory text for this bill format")
