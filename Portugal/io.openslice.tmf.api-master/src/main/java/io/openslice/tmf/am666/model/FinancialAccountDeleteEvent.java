...
public class FinancialAccountDeleteEvent   {
  ...
  @JsonProperty("event")
  private FinancialAccountDeleteEventPayload event = null;
  ...
  **/
  ...
  public FinancialAccountDeleteEvent event(FinancialAccountDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  **/
  ...
  public FinancialAccountDeleteEventPayload getEvent() {
    return event;
  }

  public void setEvent(FinancialAccountDeleteEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, financialAccountDeleteEvent.id) &&
        ...
        Objects.equals(this.event, financialAccountDeleteEvent.event);
  }
