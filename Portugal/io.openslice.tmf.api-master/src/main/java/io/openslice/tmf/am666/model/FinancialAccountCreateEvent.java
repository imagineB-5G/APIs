...
public class FinancialAccountCreateEvent   {
  ...
  @JsonProperty("event")
  private FinancialAccountCreateEventPayload event = null;
  ...
  **/
  ...
  public FinancialAccountCreateEvent event(FinancialAccountCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  **/
  ...
  public FinancialAccountCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(FinancialAccountCreateEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, financialAccountCreateEvent.id) &&
        ...
        Objects.equals(this.event, financialAccountCreateEvent.event);
  }
