...
public class ServiceCreateNotification extends Notification  {
  

  @JsonProperty("event")
  private ServiceCreateEvent event = null;

  public ServiceCreateNotification eventId(String eventId) {
  ...
  public ServiceCreateNotification event(ServiceCreateEvent event) {
    this.event = event;
    return this;
  }
  ...
  **/
  ...
  public ServiceCreateEvent getEvent() {
    return event;
  }

  public void setEvent(ServiceCreateEvent event) {
    this.event = event;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ServiceCreateNotification serviceCreateNotification = (ServiceCreateNotification) o;
